...
const ko = {
  ...
  'msg.noTrendline': '두 개 이상의 고점·저점을 잇는 추세선을 찾지 못했습니다.',
  ...
  'reply.unusable': 'AI 응답을 명령으로 바꾸지 못해 내장 파서로 처리했습니다.',
...
const en: Record<MessageKey, string> = {
  ...
  'msg.noTrendline': 'No line connects two or more pivots in this window.',
  ...
  'reply.unusable': 'The AI reply could not be turned into commands, so the built-in parser handled it.',
